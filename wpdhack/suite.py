...
def plot_obsv_v_pred(
    ...
    **scatter_kwargs
    ...
    common_idxs = s_observed.index.intersection(s_prediction.index.tz_localize('UTC'))
    s_observed, s_prediction = s_observed.loc[common_idxs], s_prediction.loc[common_idxs.tz_localize(None)]
...
def plot_pred_sample(
    ...
    common_idxs = df_pred.index.tz_localize('UTC').intersection(df_target.index)
    df_pred, df_target = df_pred.loc[common_idxs.tz_localize(None)], df_target.loc[common_idxs]
